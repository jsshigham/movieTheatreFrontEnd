  ...
  return (
    <div className="p-4 flex h-screen flex-col gap-5 items-center justify-start">
      ...
      {loading ? (
        ...
        <div className=" w-3/4 h-full grid justify-center sm:grid-cols-2 lg:grid-cols-3  gap-5 p-2">
          {movies.map((movie) => {
            return (
              <div
                key={movie._id}
                className="flex flex-col items-center justify-start gap-3 h-full border-2 p-2 border-sky-950 rounded"
              >
